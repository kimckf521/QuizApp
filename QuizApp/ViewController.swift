...
class ViewController: UIViewController, QuizProtocol, UITableViewDelegate, UITableViewDataSource,ResultViewControllerProtocol {
    ...
    func displayQuestion() {
        ...
        // Check if there are questions and check that the currectQuestionIndex is not out of bounds
    ...
    func questionsRetrieved(_ questions: [Question]) {
        ...
        let saveIndex = StateManager.retrieveValue(key: StateManager.questionIndexKey) as? Int
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // User has tapped on a row, check if it is the right number
        let question = questions[currentQuestionIndex]
